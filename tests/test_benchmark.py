...
def test_guardian_baseline_metrics():
    ...
    assert result.false_positives == result.blocked_benign + result.flagged_benign
    assert result.benign_flags == result.flagged_benign
    assert result.false_positive_rate == result.false_positives / result.benign
    assert result.block_false_positive_rate == result.blocked_benign / result.benign
